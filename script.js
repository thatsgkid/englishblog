...
const openModal1 = function () {
  ...
  We have all heard of the mathematical constant &pi;(pi), thanks to its significance in geometry and trigonometry. But did you know that there is another fundamental circle constant, &tau;(tau) which hopes to replace &pi;? Let us look at why people believe &pi; needs to be changed and how Tau could help the world of mathematics.<br>
	...
	Many natural phenomena, such as weather patterns or pendulums, follow sinusoidal cycles. However, these cycles are often shown across 2&pi;. This can lead to confusion and complexities in models. Embracing &tau; allows us to simply state that one cycle is &tau;, making it easier for learners and researchers to work with periodic phenomena.<br>
	This topic may seem inconsequential to most of us but the foundation of mathematics plays an important role in life whether you realize it or not. Mathematics is the foundation of various fields like engineering or computer theory and having a basic idea of the math behind our world will help us solve problems faster. Through &tau;, we have the opportunity to make math more accessible to everyone.<br>

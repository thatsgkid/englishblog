...
const openModal1 = function () {
  ...
  <br>
	...
	Many natural phenomena, such as weather patterns or pendulums, follow cycles with regular crests and troughs. However, these cycles are often shown across 2&pi;. This can lead to confusion and complexities in models. Embracing &tau; allows us to simply state that one cycle is &tau;, making it easier for learners and researchers to work with periodic phenomena.<br>
	This topic may seem inconsequential to most of us but the foundation of mathematics plays an important role in life whether you realize it or not. Math describes the fabric of our existence and is the cog turning the great human machine. Everything humanity has done has been an offshoot of math at some point including creativity and art. So, through relation, math is the language of humanity’s development impacting everything from engineering to computer science. Through &tau;, we have the opportunity to make math more accessible to everyone.<br>
